...
//        canvas.drawRect(rec, paint);
        canvas.drawLine(deviceWidth / 2, deviceHeight / 4, deviceWidth / 2, deviceHeight / 4 * 3, paint);
        canvas.drawLine(deviceWidth / 4, deviceHeight / 2, deviceWidth / 4 * 3, deviceHeight / 2, paint);
